...
class SudokuGenerator:
    ...
    def __init__(self, row_length: int, removed_cells: int) -> None:
        ...
        self.removed_cells    - the total number of cells to be removed from the board
        self.board            - a 2D matrix of ints to represent the board
    ...
    def fill_box(self, row_start, col_start):
        ...
        for row in range(row_start, row_start+self.box_length):
            for col in range(col_start, col_start+self.box_length):
                unused_value = unused_in_box[random.randint(0, len(unused_in_box))]
    ...
    def fill_diagonal(self):
        ...
        for i in range(0, self.row_length//self.box_length):
            self.fillbox(i*self.box_length, i*self.box_length)
        return
    ...
    def remove_cells(self):
        ...
        while count < self.removed_cells:
            rand_row = random.randint(1,self.row_length)
            rand_col = random.randint(1, self.row_length)
